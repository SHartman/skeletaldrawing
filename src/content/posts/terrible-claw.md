...
It's *[Deinonychus antirrhopus](http://en.wikipedia.org/wiki/Deinonychus)*, the quintessential "bird-like" dinosaur that John Ostrom discovered in the 1960s. More than any other discovery. it is responsible for sparking the [Dinosaur Renaissance](http://en.wikipedia.org/wiki/Dinosaur_renaissance) of the 1960s and '70s. Bob Bakker's illustration of *Deinonychus* for Ostrom's monograph is probably the single most famous piece of paleo art ever produced (although it looks awfully cold in its featherless nudity!).
...
There are a couple of unpublished specimens floating around, but this skeletal is based almost entirely on the [Yale Peabody Museum](http://peabody.yale.edu/) and [AMNH](http://www.amnh.org/) specimens that compromised Ostrom's original papers. Happily there is enough overlap that I don't anticipate any large changes.
...
Hopefully new specimens will clear those points up soon. The good news is those are fairly minor changes to make if necessary. In the mean time, I'm off to work on more skeletals, as well as preparing for my upcoming course on [advanced creature design](https://static.squarespace.com/static/51bf1cd3e4b0a897bf54112b/51bf3576e4b0f16202a228fe/51bf3577e4b0f16202a22950/1340028167000/), which is now officially [open to registration](http://www.visualarium.com/advanced-creature-anatomy-webinar/).
