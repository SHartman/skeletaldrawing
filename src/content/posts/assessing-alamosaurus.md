...
Finally, there's the incomplete tibia from Mexico described in 2006. It's truly a monster in size - even a conservative estimate yields a length of 165 cm - that's a shin bone that is almost as tall as I am! Assuming that this really is *Alamosaurus*, scaling up the adult specimen results in an animal that could have stretched 28-30 meters, and tipped the scales with the likes of *[Argentinosaurus](http://en.wikipedia.org/wiki/Argentinosaurus)* and *Puertasaurus*.
