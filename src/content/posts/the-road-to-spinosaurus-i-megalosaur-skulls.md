---
title: "The road to Spinosaurus I: Megalosaur skulls"
date: 2020-11-24T05:48:29Z
...
But about two years ago as I worked up my [*Eustreptospondylus* skeletal](https://www.skeletaldrawing.com/theropods/eustreptospondylus) (based on the excellent redescription by Sadlier, et al., 2008), I was struck by how long and slender the skull was. Shortly after that I also got to see the newly reconstructed *Torvosaurus* skull that has gone on display in the [Museum of Natural History & Science in Cincinnati](https://www.cincymuseum.org/sciencemuseum/), which also features a longer and (mostly) lower snout than past reconstructions. Having seen the material the remains are based on, I went back and checked the assumptions in my original skeletal and realized they would absolutely fit together this way - I had been working from the tall & blocky historical impression previously.

The more complete skull of [*Dubreuillosaurus*](https://en.wikipedia.org/wiki/Dubreuillosaurus) definitely has a long and low skull; and it’s possible the skull was even longer than most current reconstructions, as the maxilla contacts with the lacrimal and jugal are not preserved, and the broken lower portion of the maxilla is shoved rather far back into the incomplete jugal region. Comparing *Dubreuillosaurus* to *Eustreptospondylus*, and their broad similarities with the less generously preserved megalosaur skulls and it looks like having long and low snouts was a common feature in the group. To that end I have reworked my skeletals of [*Torvosaurus*](https://www.skeletaldrawing.com/theropods/torvosaurus), [*Marshosaurus*](https://www.skeletaldrawing.com/theropods/marshosaurus), and [*Megalosaurus*](https://www.skeletaldrawing.com/theropods/megalosaurus) to better match their relatives, and added [*Eustreptospondylus*](https://www.skeletaldrawing.com/theropods/eustreptospondylus) to the [Theropod skeletal gallery](https://www.skeletaldrawing.com/theropods).

Of course none of these skulls is as specialized as what we see in spinosaurs, but with stout thumb claws and long, low snouts megalosaurs no longer seem such a weirdo home\* for spinosaurs. So that’s the broad context, but what about non-Spinosaurus spinosaurs? More soon!

**This post was brought to you by Permia**

With their attention to detail, good eye for color design, and high quality materials the good folks at Permia produce some of the best paleo-themed merchandise out there. [Go check them out!](https://www.permia.com/)

\* A 2019 paper by Rahut & Pol has created some disagreement about whether traditional megalosaurs form a single monophyletic group, or are actually a paraphyletic grade theropods below allosaurs. This is the sort of thing that takes lots of new studies (and therefore time) to resolve, but if spinosaurs and other “megalosaurs” are a grade much of the above discussion still holds.
