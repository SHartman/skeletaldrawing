...
image:
  ...
  caption: "From here. Copyright Gregory S. Paul."
---
...
One really tricky issue with pterosaurs is the wings - we don't know for certain where the wings attached in most species, and even if we pick a particular attachment point, there are a range of potential resulting wing shapes (if you want to read more about this issue, check out the section on flight over at [pterosaur.net](http://pterosaur.net/)).

(Image from [David Hone's](http://archosaurmusings.wordpress.com/2010/09/15/on-a-wing-and-an-ankle-attachement/) blog.)
...
[Mike Habib](http://www.chatham.edu/academics/programs/undergraduate/biology/faculty_get.cfm?FacultyID=196)
