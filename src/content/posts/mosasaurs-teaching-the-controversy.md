...
At this point I am still persuaded by the hypocercal tail model, although there's definitely a bit of gray here even assuming a bilobed tail. It's possible that the angle of the tail should be closer to Dan's preferred 30 degree orientation, though I note that with the updated chevrons there shouldn't be a problem with a lack of clearance between them when putting the tail into a 40 degree bend (which is already lower than the preserved tail of ***[Platecarpus](https://en.wikipedia.org/wiki/Platecarpus),*** which does seem to have a problem with chevron-to-chevron contact). It's also possible that the top portion of the tail could be a bit smaller, like that seen [*Prognathodon*](https://en.wikipedia.org/wiki/Prognathodon), though note that *Tylosaurus* is more closely related to *Platecarpus* than to *Prognathodon*.
