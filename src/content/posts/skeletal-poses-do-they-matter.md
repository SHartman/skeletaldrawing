...
image:
  ...
  alt: "Skeletal reconstruction of Allosaurus balanced in an implausible handstand pose, tail arced upward"
---
...
So why not use this pose? Certainly it would be easy to build up a "brand" around such a pose. Yet I'd submit to you that skeletal reconstructions with inaccurate biomechanics undercut the value of a skeletal by virtue of the added theoretical "baggage". [Mike Habib](http://www.linkedin.com/profile/view?id=14472945&authType=NAME_SEARCH&authToken=bg2Y&locale=en_US&srchid=c56fe3fb-9338-44e8-a4bc-52cf6a0305b2-0&srchindex=1&srchtotal=39&goback=%2Efps_PBCK_*1_Michael_Habib_*1_*1_*1_*1_*2_*1_Y_*1_*1_*1_false_1_R_true_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2_*2&pvs=ps&trk=pp_profile_name_link), clever gentleman that he is, anticipated this point in his comment on the [previous](/images/blog/skeletal-poses-do-they-matter-4.png)article, which I'll quote below:
...
![Line-drawing skeletal reconstruction of Silesaurus in left lateral standing pose from its original description](/images/blog/skeletal-poses-do-they-matter-2.webp)
...
(Image from [here](http://bi.gazeta.pl/im/8/1079/z1079568X.jpg); artist unattributed.)
...
![Exploded diagram of a Styracosaurus skeleton with skull, vertebral series, and limb bones separated out](/images/blog/skeletal-poses-do-they-matter-3.webp)
