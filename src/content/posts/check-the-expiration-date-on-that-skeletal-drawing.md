...
![A tweet from Luigi favorably reviewing the new website, comparing the experience to the early days of Wikipedia and older, interactive WWD websites](/images/blog/Luigi%20review.png){width=50% right}

Since then I've been trying to add some of the rigorous skeletals I skipped because they took too much time to update before the launch, and made a few polish updates under the hood. But I did get one request I wanted to address, involving the loss of the last-modified dates I used to include on each image. When I did the redesign, I wanted to add my website alongside the copyright claim, so when users post images in forums or on social media people can see where to find the originals. To prevent the watermark from getting out of control, I sacrificed the "last modified" date.

![Social media post from RJ Palmer indicating how much better he finds scrolling through the new galleries](/images/blog/RJ%20Palmer%20review.jpg){width=50% left}
...
![Prasokour was one of several people asking about the disappearance of the copyright dates from the images](/images/blog/Prasokour%20request.jpg){width=90%}

So as of...just now...every primary skeletal image should have its birth year, and the year it was most recently modified in the data blocks below it. Additional images have the dates at the end of their respective captions. When deciding on origin dates, I only included images that are directly connected in some way to the current version - for example in the pre-SD.COM era I drew _Coelophysis_ and _Tyrannosaurus_ skeletals (the latter based on Sue, FMNH PR 2081) that were ultimately abandoned before starting over with more modern techniques. So the created dates for those taxa reflect their starting-over points. 
...
![A screen capture of the new drawn and revised formatting on skeletal pages](/images/blog/new-dates-format.png){width=50% right}
...
Thanks to [Luigi](https://x.com/antrodemus), [RJ Palmer](https://x.com/arvalis) and [Prasokour](https://x.com/prasokour) for letting me use their posts here, and to everyone who took the time to provide feedback.

That is, after all, how the dates returned. Now I can turn my attention to adding content, and hopefully in a couple more weeks, launching a new feature for the website. Cheers!
